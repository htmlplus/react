...
let Accordion$1 = class Accordion {
    ...
    render() {
        return uhtml.html `<div aria-controls="content" aria-disabled=${!!this.disabled} aria-expanded=${!!this.open} class="header" part="header" role="button" tabindex=${this.disabled ? -1 : 0} ref=${$element => this.$header = $element} onClick=${this.onClick} onKeyDown=${this.onKeyDown}>
        ...
        </div><div aria-labelledby="header" class="body" role="region" ref=${$element => this.$body = $element}>
