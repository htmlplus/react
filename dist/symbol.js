import { _ as __decorate, P as Property, S as State, d as Attributes, g as toUnit, c as styles, h as host, a as __awaiter, b as Element } from './index-2b3ba3ff.js';
import { g as getConfig, s as setConfig } from './config-aa3739b5.js';
 ...
 */
let Symbol$1 = Symbol_1 = class Symbol {
    get attributes() {
    ...
    connectCallback() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!defaults)
                return;
            yield import('./index2-326502de.js');
        });
    }
    get cache() {
...
Symbol$1.TAG = "plus-symbol";
// THIS PROPERTY IS AUTO-ADDED, DO NOT EDIT MANUALY
Symbol$1.STYLES = css_248z;
__decorate([
    Property({
        reflect: true,
        type: 256
    })
], Symbol$1.prototype, "color", void 0);
__decorate([
    Property({
        reflect: true,
        type: 8
    })
], Symbol$1.prototype, "flip", void 0);
__decorate([
    Property({
        type: 256
    })
], Symbol$1.prototype, "label", void 0);
__decorate([
    Property({
        type: 256
    })
], Symbol$1.prototype, "name", void 0);
__decorate([
    Property({
        type: 0
    })
], Symbol$1.prototype, "resolver", void 0);
__decorate([
    Property({
        reflect: true,
        type: 64
    })
], Symbol$1.prototype, "rotate", void 0);
__decorate([
    Property({
        reflect: true,
        type: 256
    })
], Symbol$1.prototype, "size", void 0);
__decorate([
    State()
], Symbol$1.prototype, "svg", void 0);
__decorate([
    Attributes()
], Symbol$1.prototype, "attributes", null);
Symbol$1 = Symbol_1 = __decorate([
    Element()
], Symbol$1);
 ...
 **************************************************/
var Symbol = proxy(Symbol$1.TAG, ['color', 'flip', 'label', 'name', 'resolver', 'rotate', 'size'], []);
