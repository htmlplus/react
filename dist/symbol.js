import { _ as __decorate, g as toUnit, c as styles, h as host, a as __awaiter, P as Property, S as State, d as Attributes, b as Element } from './index-e0fc73b0.js';
...
let Symbol$1 = class Symbol {
    ...
    connectCallback() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.defaults)
                return;
            yield import('./index2-2881714d.js');
        });
    }
    update(input) {
        var _a;
...
], Symbol$1.prototype, "defaults", void 0);
__decorate([
    Property({
        reflect: true,
        type: 8
 ...
 **************************************************/
var Symbol = proxy(Symbol$1.TAG, ['color', 'defaults', 'flip', 'label', 'name', 'resolver', 'rotate', 'size'], []);
